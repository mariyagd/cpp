...
void	test_constructors( void )
{
	...
	DiamondTrap	second("James");
	printDiamondTrap(second);

	DiamondTrap	third(second);
	printDiamondTrap(third);

	DiamondTrap	forth = first;
	printDiamondTrap(forth);
...
{
	std::cout << "Attack test between a DiamondTrap and a ScavTraps:" << std::endl;
	print_line();
